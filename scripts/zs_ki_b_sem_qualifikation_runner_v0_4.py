#!/usr/bin/env python3
"""One-shot local SEM qualification runner v0.4 for R16/R18/R21/R22.

Preserves the v0.3 SEM prompt/cases/contract/boundary behavior and changes only
the structured local transport binding to v0.4 with a 600s default timeout.
"""
from __future__ import annotations

import scripts.zs_ki_b_sem_qualifikation_runner_v0_1 as base
from llm.local_model.structured_output_v0_4 import chat_completion_structured
...
RUN_TYPE = "ZS-KI-B-SEM-QUALIFIKATION-SYNTHETIC-ONE-RUN-2026-004"
RUNNER_VERSION = "v0.4"
DEFAULT_OUTPUT = "zs_ki_b_sem_qualifikation_result_v0_4.json"
