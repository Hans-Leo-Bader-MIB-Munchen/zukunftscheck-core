...
EXPECTED_COMMIT = "8e8509d9b534edcd2b82adfb0ec54ad7b0db5620"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Execute exactly one model-free frozen 29-case system qualification pass.")
