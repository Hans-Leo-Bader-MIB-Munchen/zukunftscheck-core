...
import scripts.zs_ki_b_sem_qualifikation_runner_v0_4 as runner
from llm.local_model.structured_output_v0_4 import chat_completion_structured


class SemQualifikationRunnerV04Tests(unittest.TestCase):
    def test_01_runner_freezes_prompt_v0_2_and_new_run_identity(self) -> None:
        ...
        self.assertEqual(runner.RUN_TYPE, "ZS-KI-B-SEM-QUALIFIKATION-SYNTHETIC-ONE-RUN-2026-004")
        self.assertEqual(runner.RUNNER_VERSION, "v0.4")
