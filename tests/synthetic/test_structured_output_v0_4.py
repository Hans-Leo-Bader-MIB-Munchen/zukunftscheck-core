...
from llm.local_model import structured_output_v0_4 as transport


class StructuredOutputV04Tests(unittest.TestCase):
    def test_01_version_and_default_timeout_are_explicit(self) -> None:
        self.assertEqual(transport.OUTPUT_MODE_VERSION, "ZS-KI-B-STRUCTURED-OUTPUT-2026-001_v0.4")
        self.assertEqual(transport.DEFAULT_TIMEOUT_SECONDS, 600.0)

    def test_02_payload_schema_is_identical_to_prior_builder(self) -> None:
    ...
    def test_03_default_timeout_600_is_passed_to_local_open(self) -> None:
        response = MagicMock()
        ...
        self.assertEqual(opener.open.call_args.kwargs["timeout"], 600.0)
