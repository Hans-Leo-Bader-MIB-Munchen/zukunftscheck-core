...
v0.4 preserves the v0.3 payload/schema behavior and raises only the default
local request timeout from 300s to 600s. No retry, repair, tool use, web access,
MCP call or remote transmission is introduced.
"""
from __future__ import annotations

from llm.local_model.structured_output_v0_3 import (
...
OUTPUT_MODE_VERSION = "ZS-KI-B-STRUCTURED-OUTPUT-2026-001_v0.4"
